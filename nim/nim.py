...
class NimAI():
    ...
    """ 
    Returns random action given a state
    """
    def random_action(self, state):
        ...
        value = random.randint(1, state[line])
        return (line, value)
    ...
    def best_action(self, state):
        ...
        for option in options:
            ...
            new_state[option[0]] = new_state[option[0]] - option[1]
            reward = self.get_q_value(state, option)
    ...
    def choose_action(self, state, epsilon=True):
        ...
        If multiple actions have the same Q-va  lue, any of those
        options is
